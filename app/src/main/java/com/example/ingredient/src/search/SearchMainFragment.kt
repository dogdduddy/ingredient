...
class SearchMainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.mainRecommendTitle3.text = "스트레스 다 날려버릴 매운맛 레시피"
        binding.mainRecommendTitle2.text = "추운 겨울을 따뜻하게 보낼 레시피"
        var span1: Spannable = binding.mainRecommendTitle1.text as Spannable
        var span3: Spannable = binding.mainRecommendTitle2.text as Spannable
        var span2: Spannable = binding.mainRecommendTitle3.text as Spannable
        ...
        span3.setSpan(ForegroundColorSpan(requireActivity().getColor(R.color.red)), 12, 15, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        span3.setSpan(StyleSpan(Typeface.BOLD), 12, 15, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        span2.setSpan(ForegroundColorSpan(requireActivity().getColor(R.color.blue)), 0, 5, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        span2.setSpan(StyleSpan(Typeface.BOLD), 0, 6, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
       return binding.root
    }
