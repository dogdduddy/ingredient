...
import com.dogdduddy.ingredient.activity.LoginActivity
...
class SessionCallback(val context : com.dogdduddy.ingredient.activity.LoginActivity): ISessionCallback {
        ...
        UserManagement.getInstance().me(object : MeV2ResponseCallback(){
            override fun onSuccess(result: MeV2Response?) {
                if(result != null){
                    ...
                    Log.d(TAG, "accessToken get Success")
