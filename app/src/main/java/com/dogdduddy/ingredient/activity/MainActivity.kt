package com.dogdduddy.ingredient.activity
...
import com.dogdduddy.ingredient.src.expirationDate.ExpirationDateFragment
import com.dogdduddy.ingredient.src.basket.BasketFragment
import com.dogdduddy.ingredient.databinding.ActivityMainBinding
import com.dogdduddy.ingredient.src.foodbook.FoodBookMainFragment
import com.dogdduddy.ingredient.src.search.SearchMainFragment
...
class MainActivity : AppCompatActivity() {
    ...
    fun setProfile(navi_header: View) {
        ...
        if(!intent.getStringExtra("photo").isNullOrBlank()) {
            ...
            navi_header.findViewById<ImageView>(R.id.nav_profile_image).setImageResource(R.drawable.profile_default_1)
        }
    }
    ...
    fun logout() {
        ...
        val intent = Intent(this, com.dogdduddy.ingredient.activity.LoginActivity::class.java)
